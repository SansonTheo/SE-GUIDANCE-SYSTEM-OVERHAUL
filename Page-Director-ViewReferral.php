                    ...
                    <div class="student-picname">
                        <div class="student-namebuttons">
                            <div class="student-info-button-container" style="height:30px;">
                                <div class="student-info-button-container" style="height:30px;">
                                    <a href="Page-Director-Resolve.php?id=<?php echo $id; ?>"  class="student-info-button" style="<?php if($referral['status'] != "Pending"){ echo "visibility:hidden;"; } ?>"><img src="imgs/new-check.png" id="check-img"><div class="button-label" id="check">Mark as Resolved</div></a>
                                    <a href="Page-Director-Deny.php?id=<?php echo $id; ?>" class="student-info-button" style="<?php if($referral['status'] != "Pending"){ echo "visibility:hidden;"; } ?>"><img src="imgs/new-deny.png" id="edit-img"><div class="button-label" id="edit" style="font-size:13px;">Deny Referral</div></a>
                                    <a href="Page-Director-CreateFromReferral.php?id=<?php echo $id; ?>" class="student-info-button" style="<?php if($referral['status'] == "Resolved"){ echo "visibility:hidden;"; } ?>"><img src="imgs/new-schedule.png" id="delete-img"><div class="button-label" id="delete">Schedule</div></a>
                ...
                <div class="student-info info-show-box  teacher-container" style="margin:0px;height:515px;">
                    <div class="info-subgroup session-main-info" style="height:calc(100% - 20px);">
                        ...
                        <div style="height:50px; grid-column:span 2;">
                            ...
                            <button onclick="directorViewStudentProfile(<?php echo $studentid; ?>)" type="button" style="background-color:#8A3838; height:50px; width:200px; position:relative; top:30px; left:7px; color:white; border-radius:5px;">View Student</button>
                        </div>
                    </div>
                </div>
            </div>
