<?php
	...
	WHERE id='$id'";
    $sql2Father = "UPDATE parent SET employer='$fatheremployer',highestdegree='$fatherhighestdegree',attendedschools='$fatherattendedschools',hobby='$fatherhobby',religion='$fatherreligion',nationality='$fathernationality' WHERE id='$fatherId'";
    $sql2Mother = "UPDATE parent SET employer='$motheremployer',highestdegree='$motherhighestdegree',attendedschools='$motherattendedschools',hobby='$motherhobby',religion='$motherreligion',nationality='$mothernationality' WHERE id='$motherId'";
    $sql2 = "UPDATE student SET placeofbirth='$placeofbirth',course='$course',attendedschools='$attendedschools',hsliked='$hsliked',hsdisliked='$hsdisliked',hsaverage='$hsaverage',classrank='$classrank',previouscourse='$previouscourse',shiftingreason='$shiftingreason',presentplans='$presentplans',choicereason='$choicereason',schoolchoicereason='$schoolchoicereason',requirementknowledge='$requirementknowledge',requirementknowledgesource='$requirementknowledgesource',financialsupport='$financialsupport',scholasticstanding='$scholasticstanding',physicalmarks='$physicalmarks',physicalprograms='$physicalprograms',physicalailments='$physicalailments',currentresidence='$currentresidence',currentresidencenumber='$currentresidencenumber',shareroomnumber='$shareroomnumber',campusorganization='$campusorganization',offcampusorganization='$offcampusorganization',awards='$awards',organization='$organization',hobby='$hobby',traits='$traits',significantevent='$significantevent',humiliation='$humiliation',previouscounseling='$previouscounseling',previouscounselingdate='$previouscounselingdate',previouscounselingcounselor='$previouscounselingcounselor',lifeproblems='$lifeproblems',connectedperson='$connectedperson',helpdetails='$helpdetails',parenttraits='$parenttraits',preferredparent='$preferredparent',parentmaritalstatus='$parentmaritalstatus',homelanguage='$homelanguage',familyathome='$familyathome',relativesathome='$relativesathome',childrenathome='$childrenathome',helpersathome='$helpersathome',children='$children',siblings='$siblings'
    WHERE id='$id'";  					            
    ...
    if(mysqli_query($link,$sql))
    {
        ...
        mysqli_query($link,$sql2Father);
        mysqli_query($link,$sql2Mother);
