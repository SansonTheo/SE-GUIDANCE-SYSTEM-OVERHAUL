    ...
    <body style="background-color: rgb(224, 224, 224); padding-top:60px; min-width:800px;">
        ...
        ?>
            ...
            <div class="subgroup-container">
                <div class="question-container">
                    <p class="question-label-with-button">Referral *
                        <button style="visibility:hidden;"  type="button" class="action-button add-button" style="width:130px; height:28px; margin-left:10px;">
                    ...
                    <input type="text" name="referall-name" id="referral-name" placeholder="Referral" readonly="readonly" style="pointer-events: none;" value="<?php
                                if(isset($referral)){
            ...
            <div class="subgroup-container">
                <div class="question-container">
                    ...
                    <p class="question-label-with-button">Student *
                        <button style="visibility:hidden;" id="addStudentHide" type="button" class="action-button add-button" style="width:130px; height:28px; margin-left:10px;">
                            <div class="action-button-label" style="font-size: 12px; flex:80%;" id="addStudent">
                                Select Student
                            </div>
                        </button>
                    </p>
                    <input class="hidden-input" type="text" name="student-id" id="student-id" value="<?php echo $student['id'] ?>">
                    <input type="text" name="student-name" id="student-name" placeholder="Student" readonly="readonly" style="pointer-events: none;" value="<?php
                                if(isset($student)){
            ...
            <div class="subgroup-container buttons">
                ...
                <button onclick="directorReturnToReferral(<?php echo $id; ?>);" type="button" class="normal-button" style="width:80px; height:40px; margin-right:10px;">
                    Cancel
                </button>
            </div>
        </form>
