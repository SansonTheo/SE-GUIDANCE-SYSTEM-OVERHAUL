                        ...
                        <div class="student-namebuttons">
                            <div class="student-info-button-container" style="height:30px;">
                                <div class="student-info-button-container" style="height:30px;">
                                    ...
                                    <a href="Page-Counselor-Resolve.php?id=<?php echo $id; ?>" class="student-info-button" style="<?php if($referral['status'] == "Resolved"){ echo "visibility:hidden;"; } ?>"><img src="imgs/new-check.png" id="edit-img"><div class="button-label" id="edit" style="font-size:13px;">Mark Resolved</div></a>
                                    <a href="Page-Counselor-Refer.php?id=<?php echo $id; ?>" class="student-info-button" style="<?php if($referral['status'] == "Resolved"){ echo "visibility:hidden;"; } ?>"><img src="imgs/new-forward.png" id="delete-img"><div class="button-label" id="delete">Refer</div></a>
