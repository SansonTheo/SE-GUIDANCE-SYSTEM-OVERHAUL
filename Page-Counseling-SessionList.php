            ...
            <div class="session-list-container">
                <div class="session-window">
                    <div class="sort-buttons" style="width:100%; height:100px; position:relative;">
                        <div onclick="sessionAdd()" class="addSession-button">
                            <div class="add-label">
                                Add Session
                            </div>
                        ...
                        <div class="session-buttons-container">
                            <div class="session-namebuttons">
                                <div class="session-info-button-container">
                                    <a onclick="viewSession()" class="session-info-button"><img src="imgs/new-view.png" id="view-img"><div class="button-label" id="view">View Session</div></a>
                                    <a href="#" class="session-info-button"><img src="imgs/new-edit.png" id="edit-img"><div class="button-label" id="edit">Edit Session</div></a>
                                    <a href="#" class="session-info-button"><img src="imgs/new-check.png" id="mark-img"><div class="button-label" id="mark">Mark as Finished</div></a>
                                </div>
                            </div>
                        </div>
