                    ...
                    <div class="student-picname">
                        ...
                        <div class="student-namebuttons">
                            <div class="student-info-button-container">
                                <div class="student-info-button-container">
                                    <a style="visibility:hidden;" href="Page-Student-EditStudent.php?id=<?php echo $id ?>" class="student-info-button"><img src="imgs/new-edit.png" id="edit-img"><div class="button-label" id="edit">Edit Student</div></a>
                                    ...
                                    <a href="Page-Student-EditStudent.php?id=<?php echo $id ?>" class="student-info-button"><img src="imgs/new-edit.png" id="print-img"><div class="button-label" id="print">Edit Data</div></a>
                                </div>
                            </div>
            ...
            <div class="family-relation-show">
                ...
                <div class="student-info info-show-box" style="margin:0px;">
                    ...
                    <div class="info-subgroup family-info" style="height:290px;">
                        <p class="info-subgroup-label">&nbsp; Emergency Contact Person &nbsp;</p>
                        <div style="grid-column: span 2;">
                            <p class="info-label">Fullname</p>
                        ...
                        <div class="student-namebuttons" >
                            <div class="student-info-button-container">
                                <div class="student-info-button-container">
                                    ...
                                    <a href="Page-Student-Add.php" class="student-info-button"><img src="imgs/new-add.png" id="print-img"><div class="button-label" id="print">Add Data</div></a>
                                </div>
                            </div>
                            <div class="student-info-name" >
