...
<html>
    ...
    <body style="background-color: rgb(224, 224, 224); padding-top:60px; min-width:800px;">
                        ...
                        <table id="referral-table" class="list-table tableFixHead">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $record = mysqli_query($link,"SELECT * FROM referral WHERE status='Pending'");
                    ...
                    <div class="info-subgroup show-button-info">
                        ...
                        <div class="info-show-text-area">
                            <div class="student-info-button-container">
                                <a style="visibility:hidden"; class="student-info-button"><img src="imgs/new-forward.png" id="view-img"><div class="button-label" id="view">Refer</div></a>
                                <a onclick="directorViewReferral()" class="student-info-button"><img src="imgs/new-view.png" id="edit-img"><div class="button-label" id="edit">View</div></a>
                                <a style="visibility:hidden"; class="student-info-button"><img src="imgs/new-view.png" id="print-img"><div class="button-label" id="print" style="font-size:15px; display:flex; justify-content:center;">View</div></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script src="js/viewreferrallist.js"></script>
