                        ...
                        <table id="referral-table" class="list-table tableFixHead">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $record = mysqli_query($link,"SELECT * FROM referral WHERE currentlevel='$currentlevel'");
                    ...
                    <div class="info-subgroup show-button-info">
                        ...
                        <div class="info-show-text-area">
                            <div class="student-info-button-container">
                                <a onclick="referCounselor()" class="student-info-button"><img src="imgs/new-forward.png" id="view-img"><div class="button-label" id="view">Refer</div></a>
                                <a onclick="resolveCounselor()" class="student-info-button"><img src="imgs/new-check.png" id="edit-img"><div class="button-label" id="edit">Resolve</div></a>
