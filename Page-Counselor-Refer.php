...
<html>
    ...
    <body style="background-color: rgb(224, 224, 224); padding-top:60px; min-width:800px;">
        ...
        <div class="title-bar">
            ...
            <div>Refer Student</div>
        </div>
        <form name="session-form" id="session-form" onsubmit="return validateForm()" class="center-container" method="post" action="refer.php">
        <?php 
                $id=$_REQUEST['id'];
        ...
        ?>
            ...
            <div class="subgroup-container">
                ...
                <div class="question-container" style="height:300px;">
                    <p>What additional actions have you taken?</p>
                ...
                <div class="question-container">
                    ...
                    <input type="text" name="contactedparentsdate" id="contactedparentsdate" placeholder="Date Parents were Contacted" <?php echo $value[2]; ?> value="<?php echo $referral['contactedparentsdate'] ?>">
                </div>
                <div class="question-container" style="height:300px;">
                    <p>What was the outcome when you contacted the parents?</p>
                    <textarea style="resize:none; height:300px;" name="contactedparentsoutcome" id="contactedparentsoutcome" form="session-form" placeholder="Explain what the outcome with the parents was. . ."  <?php echo $value[2]; ?>><?php echo $referral['contactedparentsoutcome'] ?></textarea>
                </div>
            </div>
