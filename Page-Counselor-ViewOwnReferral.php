                        ...
                        <div class="student-namebuttons">
                            <div class="student-info-button-container" style="height:30px;">
                                <div class="student-info-button-container" style="height:30px;">
                                    ...
                                    <a style="<?php if($referral['status'] == "Resolved"){ echo "visibility:hidden;"; } ?>" href="Page-Counselor-ResolveOwn.php?id=<?php echo $id; ?>" class="student-info-button"><img src="imgs/new-check.png" id="delete-img"><div class="button-label" id="delete">Mark Resolved</div></a>
