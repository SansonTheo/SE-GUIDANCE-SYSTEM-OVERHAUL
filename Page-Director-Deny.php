...
<html>
    ...
    <body style="background-color: rgb(224, 224, 224); padding-top:60px; min-width:800px;">
        ...
        <div class="title-bar">
            ...
            <div>Deny Referral</div>
        </div>
        <form name="session-form" id="session-form" onsubmit="return validateForm()" class="center-container" method="post" action="denyDirector.php">
        <?php 
                $id=$_REQUEST['id'];
        ...
        ?>
            ...
            <div class="subgroup-container">
                ...
                <div class="question-container">
                    ...
                    <input class="hidden-input" type="text" name="currentlevel" id="currentlevel" value="<?php echo "4"; ?>">
                ...
                <div class="question-container" style="height:300px;">
                    <p>Please state the reason for denying this referral</p>
                    <textarea style="resize:none; height:300px; padding-left:10px;" name="actiontaken" id="actiontaken" form="session-form" placeholder="Explain Actions Already Taken. . ."></textarea>
                </div>
                <div class="question-container">
                <?php
                    $value = [
