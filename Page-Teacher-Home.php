            ...
            <div style="height:100%; flex:45%;">
                <div class="student-window">
                    <div class="sort-buttons" style="width:100%; height:100px;">
                        <div onclick="referralAdd()" class="addSession-button">
                            <div class="add-label">
                                Create Referral
                            </div>
                    ...
                    <div class="info-subgroup show-button-info">
                        ...
                        <div class="info-show-text-area">
                            <div class="student-info-button-container">
                                ...
                                <a onclick="viewReferralTeacher();" class="student-info-button"><img src="imgs/new-view.png" id="edit-img"><div class="button-label" id="edit">View</div></a>
                                <a style="visibility:hidden;" href="#" class="student-info-button"><img src="imgs/new-view.png" id="print-img"><div class="button-label" id="print" style="font-size:15px; display:flex; justify-content:center;">View</div></a>
                            </div>
                        </div>
                    </div>
                </div>
