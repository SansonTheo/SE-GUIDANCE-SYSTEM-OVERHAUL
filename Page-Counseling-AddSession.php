...
<html>
    ...
    <body style="background-color: rgb(224, 224, 224); padding-top:60px; min-width:800px;">
        ...
        <form name="session-form" id="session-form" onsubmit="return validateForm()" class="center-container" method="post" action="counselingAdd.php">
            ...
            <div class="subgroup-container list-container">
                ...
                <div class="question-container" style="height: calc(100% - 35px);">
                    ...
                    <p style="font-size:12px;">At least 1</p>
                    <div class="table-container">
                        <input type="text" class="hidden-input" id="studentCount" name="studentCount" value="-1">
            ...
            <div class="subgroup-container list-container">
                ...
                <div class="question-container" style="height: calc(100% - 35px);">
                    ...
                    <div class="table-container">
                        <input type="text" class="hidden-input" id="teacherCount" name="teacherCount" value="-1">
            ...
            <div class="subgroup-container list-container">
                ...
                <div class="question-container" style="height: calc(100% - 35px);">
                    ...
                    <div class="table-container">
                        <input type="text" class="hidden-input" id="parentCount" name="parentCount" value="-1">
