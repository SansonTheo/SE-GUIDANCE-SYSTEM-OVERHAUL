            ...
            <div style="height:100%; flex:60%;">
                <div class="student-window">
                    <div class="sort-buttons" style="width:100%; height:100px;">
                        <div onclick="toggleAdd()" class="add-button" id="addStudent">
                            <div class="add-label">
                                Add Student
                            </div>
                            <div class="add-or-import">
                                <ul>
                                    <li>Add Manually</li>
                                    <li style="margin-top:5px;">Import from File</li>
                                </ul>
                            </div>
                    ...
                    <div class="student-picname">
                        ...
                        <div class="student-namebuttons">
                            <div class="student-info-button-container">
                                <a onclick="viewStudent()" class="student-info-button"><img src="imgs/new-view.png" id="view-img"><div class="button-label" id="view">View Student</div></a>
                                <a onclick="editStudent()" class="student-info-button"><img src="imgs/new-edit.png" id="edit-img"><div class="button-label" id="edit">Edit Student</div></a>
