...
<html>
    ...
    <body style="background-color: rgb(224, 224, 224); padding-top:60px; min-width:800px;">
        ...
        <form name="session-form" id="session-form" onsubmit="return validateForm()" class="center-container" method="post" action="directorCounselingEdit.php">
        <?php 
                $id=$_REQUEST['id'];
            ...
            <div class="subgroup-container">
                ...
                <div class="question-container">
                    <p class="question-label-with-button">Referral *
                        <button type="button" class="action-button add-button" style="<?php if(isset($referral)){ echo "display:none;"; } ?> width:130px; height:28px; margin-left:10px;">
                    ...
                    <input type="text" name="referral-name" id="referral-name" placeholder="Referral" readonly="readonly" style="pointer-events: none; <?php if(isset($referral)){ echo "background:whitesmoke;"; } ?>" value="<?php
                                if(isset($referral)){
            ...
            <div class="subgroup-container">
                <div class="question-container">
                    ...
                    <p class="question-label-with-button">Student *
                        <button id="addStudentHide" type="button" class="action-button add-button" style="<?php if(isset($student)){ echo "display:none;"; } ?> width:130px; height:28px; margin-left:10px;">
                    ...
                    <input type="text" name="student-name" id="student-name" placeholder="Student" readonly="readonly" style="pointer-events: none; <?php if(isset($student)){ echo "background:whitesmoke;"; } ?>" value="<?php
                                if(isset($student)){
            ...
            <div class="subgroup-container buttons">
                ...
                <button onclick="directorReturnToSession(<?php echo $id?>)" type="button" class="normal-button" style="width:80px; height:40px; margin-right:10px;">
                    Cancel
                </button>
            </div>
        </form>
